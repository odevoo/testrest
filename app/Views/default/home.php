                ...
                <div class="col-md-12">
                    <div>
                        ...
                        <ul class="list-inline menu-tabs margin-b-30" role="tablist">
                            <li role="presentation" class="active"><a href="#formules" aria-controls="formules" role="tab" data-toggle="tab">Formules</a></li>
                            <li role="presentation"><a href="#carte" aria-controls="carte" role="tab" data-toggle="tab">Carte</a></li>
                            <li role="presentation"><a href="#degustation" aria-controls="degustation" role="tab" data-toggle="tab">Dégustations</a></li>
                            <li role="presentation"><a href="#boisson" aria-controls="boisson" role="tab" data-toggle="tab">Boissons</a></li>
                        </ul>

                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="formules">
                        ...
                        <!-- <div class="testi-slider">
                            <ul class="slides">
                                ...
                                <li>
                                    ...
                                    <div class="testi-info">
                                        <img src="assets/images/avtar-3.jpg" alt="" width="50" class="img-circle">
                                        <h4>John Doe <small> - Resto customer</small></h4>                                           
                                        <i class="ion-star"></i>
                                        <i class="ion-star"></i>
                                        <i class="ion-star"></i>
